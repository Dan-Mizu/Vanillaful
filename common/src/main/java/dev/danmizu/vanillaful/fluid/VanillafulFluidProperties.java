...
public record VanillafulFluidProperties(
	ResourceLocation id,
	double motionScale,
	...
	public static class Builder {
		...
		private final VanillafulFluidSounds sounds = new VanillafulFluidSounds();
		...
		public VanillafulFluidProperties build(ResourceLocation id) {
			return new VanillafulFluidProperties(
				id,
				motionScale,
				canPushEntity,
				canSwim,
