...
public abstract class GelFluidBlock extends FlowableFluid {
	/**
	...
	public Fluid getStill() {
		return ModBlocks.STILL_GEL;
	}

	@Override
	public Fluid getFlowing() {
		return ModBlocks.FLOWING_GEL;
	}

	@Override
	public Item getBucketItem() {
		return ModBlocks.GEL_BUCKET;
	}

	@Override
	protected BlockState toBlockState(FluidState fluidState) {
		return ModBlocks.GEL.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(fluidState));
	}

	public static class Flowing extends GelFluidBlock {
		@Override
	...
	public static class Still extends GelFluidBlock {
		@Override
		public int getLevel(FluidState fluidState) {
			return 8;
		}
