...
public class Vanillaful implements ModInitializer {
	...
	public void onInitialize() {
		...
		BlockRenderLayerMap.INSTANCE.putBlock(Vanillaful.SPRUCE_LADDER, RenderLayer.getCutout());
		//Birch Stick
		...
		BlockRenderLayerMap.INSTANCE.putBlock(Vanillaful.BIRCH_LADDER, RenderLayer.getCutout());
		//Jungle Stick
		...
		BlockRenderLayerMap.INSTANCE.putBlock(Vanillaful.JUNGLE_LADDER, RenderLayer.getCutout());
		//Acacia Stick
		...
		BlockRenderLayerMap.INSTANCE.putBlock(Vanillaful.ACACIA_LADDER, RenderLayer.getCutout());
		//Dark Oak Stick
		...
		BlockRenderLayerMap.INSTANCE.putBlock(Vanillaful.DARK_OAK_LADDER, RenderLayer.getCutout());
		//Crimson Stick
		...
		BlockRenderLayerMap.INSTANCE.putBlock(Vanillaful.CRIMSON_LADDER, RenderLayer.getCutout());
		//Warped Stick
		...
		BlockRenderLayerMap.INSTANCE.putBlock(Vanillaful.WARPED_LADDER, RenderLayer.getCutout());
		...
		//BlockRenderLayerMap.INSTANCE.putBlock(Vanillaful.NETHER_BRICK_FENCE_GATE, RenderLayer.getCutout());
